...
import pt.iscte.pidesco.cfgviewer.internal.demos.DemoFigure;
	...
	class GraphLabelContentProvider extends LabelProvider implements IFigureProvider, IConnectionStyleProvider {
		...
		public IFigure getFigure(Object element) {
			if (element instanceof IStatementNode) {
				...
				return new CFGBranchFigure(node.getElement().toString());
			} else {
			...
			return new DemoFigure(((INode)element).toString());
		}
